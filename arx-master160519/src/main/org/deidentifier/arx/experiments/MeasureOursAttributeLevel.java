...
public class MeasureOursAttributeLevel {
	...
	private static String output = generatedDataPath + "..\\our_att_level.csv";
	...
	public static void main(String args[]) throws Exception {
		...
		bw.write(
				"QIs,k,maxChanges,QI,gen. intensity,granularity,n.u. entropy,sq. err.\n");
			...
			for (int k = 2; k <= 10; k++) {
				for (int maxChanges = 9; maxChanges <= QISize; maxChanges++) {
					...
					Data dataTransformed = Data.create(
							generatedDataPath + "QIs_" + QISize + "_k_" + k + ".csv",
