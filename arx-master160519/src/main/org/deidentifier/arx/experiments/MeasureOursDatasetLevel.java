...
public class MeasureOursDatasetLevel {

	private static String datasetPath = "C:\\Users\\abampoulidis\\Desktop\\safedeed\\conferences\\tbd-demo-short\\input\\";
	private static String generatedDataPath = "C:\\Users\\abampoulidis\\Desktop\\safedeed\\conferences\\tbd-demo-short\\output\\case2\\our\\";
	...
	private static String output = generatedDataPath + "..\\our_dataset_level.csv";

	public static void main(String args[]) throws Exception {
		BufferedWriter bw = new BufferedWriter(
				new OutputStreamWriter(new FileOutputStream(output), StandardCharsets.UTF_8));

		bw.write("QIs,k,maxChanges,gen. intensity,granularity,n.u. entropy,record-level sq. err.,att.-level sq. err.\n");
		...
		for (int QISize = 9; QISize <= 9; QISize++) {
			...
			for (int k = 2; k <= 10; k++) {
				for (int maxChanges = 9; maxChanges <= QISize; maxChanges++) {
					Data dataOrig = Data.create(datasetPath + "adult_" + QISize + ".csv", StandardCharsets.UTF_8, ';');
					Data dataTransformed = Data.create(generatedDataPath + "QIs_" + QISize + "_k_" + k + ".csv",
...
//					setAttributeWeights(config, QISize);
					...
					System.out.println(QISize + "," + k + "," + maxChanges + ",");
					bw.write(QISize + "," + k + ",");
